...
namespace DIO.Bank
{
	class Program
	{
		...
		static void Main(string[] args)
		{
			...
			Console.WriteLine("O DIOBank agradece a preferencia!.");
			Console.ReadLine();
		}
		...
		private static void InserirConta()
		{
			...
			Console.Write("Digite 1 para Conta Corrente ou 2 para Conta Poupança: ");
			int entradaTipoConta = int.Parse(Console.ReadLine());

			Console.Write("Insira o Nome do Cliente: ");
			string entradaNome = Console.ReadLine();

			Console.Write("Insira o valor de Deposito para abertura da conta: ");
